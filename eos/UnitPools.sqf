...
// EAST CSAT FACTION
	if (_faction==0) then {
	_InfPool=	["O_T_Soldier_A_F","O_T_Soldier_AAR_F","O_T_Support_AMG_F","O_T_Support_AMort_F","O_T_Soldier_AAT_F","O_T_Soldier_AR_F","O_T_Medic_F","O_T_Engineer_F","O_T_Soldier_Exp_F","O_T_Soldier_GL_F","O_T_Support_GMG_F","O_T_Support_MG_F","O_T_Sniper_F","O_T_ghillie_tna_F","O_T_Recon_F","O_T_Recon_Exp_F","O_T_Recon_JTAC_F","O_T_Recon_M_F","O_T_Recon_Medic_F","O_T_Recon_LAT_F","O_V_Soldier_ghex_F","O_V_Soldier_TL_ghex_F","O_V_Soldier_Exp_ghex_F","O_V_Soldier_Medic_ghex_F","O_V_Soldier_LAT_ghex_F","O_V_Soldier_JTAC_ghex_F"];	
	_ArmPool=	["O_T_MBT_04_command_F","O_T_APC_Tracked_02_cannon_ghex_F","O_T_APC_Tracked_02_AA_ghex_F","O_T_APC_Wheeled_02_rcws_ghex_F","O_T_MBT_02_cannon_ghex_F","O_T_MBT_02_arty_ghex_F"];
	_MotPool=	["O_T_LSV_02_armed_F","O_LSV_02_armed_F","O_T_MRAP_02_hmg_ghex_F","O_T_MRAP_02_gmg_ghex_F","O_T_Truck_03_covered_ghex_F","O_T_Truck_03_repair_ghex_F","O_T_Truck_03_ammo_ghex_F","O_T_Truck_03_medical_ghex_F"];
	_ACHPool=	["O_Heli_Attack_02_black_F","O_Plane_Fighter_02_F"];
	_CHPool=	["O_T_VTOL_02_infantry_F","O_Heli_Transport_04_covered_F"];
	_uavPool=	["O_T_UAV_04_CAS_F","O_T_UGV_01_rcws_ghex_F"];
	_stPool=	["O_Static_Designator_02_F","O_SAM_System_04_F","O_Radar_System_02_F"];
	...
	_heliCrew=	["O_T_Pilot_F","O_T_Helicrew_F"];
};
// WEST NATO FACTION	
	if (_faction==1) then {
